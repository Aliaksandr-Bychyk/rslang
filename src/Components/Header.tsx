...
function Header(): JSX.Element {
    ...
    const menuItems: IMenuItems[] = [{value: "Главная", component: '<Main/>'}, {value: "Учебник", component: 'Tutorial'},
        {value: "Словарь", component: '<Dictionary/>'}, {value: "Мини-игры", component: '<Game/>'}, {value: "Статиска", component: '<Stats/>'}];
            ...
            <div className="container">
                <div className="header__wrapper">
                    <nav className="navigation">
                        <div className={menuActive ? 'burger__btn burger_active ' : 'burger__btn'} onClick={() => {setMenuActive(!menuActive)}}>
                            <span/>
                        </div>
                    </nav>
                    <button className="button auth__btn" onClick={() => {setAuthActive(!authActive)}}>
